...
const NewsSection = () => {
  ...
  return (
    <div className="bg-white py-12 px-6 mr-16 ml-16">
      <div className="max-w-7xl mx-auto text-center">
        {/* Header */}
        <h2 className="text-3xl font-bold text-gray-800 mb-2">
          Explore our current
        </h2>
        <h2 className="text-3xl text-gray-600 mb-12 font-bold">
          Update in <span className="font-bold text-gray-800">News and Blog</span>
        </h2>
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button className="px-4 py-2 rounded border border-green-600 bg-green-600 text-white text-sm font-medium hover:bg-green-700 hover:text-white">
                    Read More
                  </button>
                </div>
              </div>
