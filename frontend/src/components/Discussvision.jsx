const Discussvision = () => {
    ...
    return (
      <div className="bg-white py-12 mb-6 px-8">
        {/* Key Milestones Section */}
        <div className="py-10 px-5 md:px-20 flex flex-col md:flex-row items-center -gap-2">
          {/* Placeholder */}
          <div className=" md:w-1/2 flex justify-center mt-8 md:mt-0 md:pr-8">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl mt-4 font-bold mb-6">WHAT WE ARE AND WHAT<br/> WE DO </h2>
